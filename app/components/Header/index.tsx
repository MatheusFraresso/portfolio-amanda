...
export default function Header() {
  return (
    <div className="px-2 lg:px-10 py-2 flex justify-between items-center sticky top-0 w-full z-10 bg-background shadow">
      <h1 className="text-3xl lg:text-[50px] font-normal font-inria w-1/3">Bonart</h1>
      <div className="flex items-center">
        ...
        <div className="flex lg:hidden items-center justify-center space-x-2  lg:space-x-6 text-xs lg:text-xl">
          <Dropdown
            openElement={<MdOutlineMenu size={20} className="text-tertiary-main" />}
